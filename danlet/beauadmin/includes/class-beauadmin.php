    ...
    class BeauAdmin {
        ...
        public function get_admin_screens_header( $screen = 'welcome' ) {
            ...
            <div <?php if($this->config['avatar'] != false) { ?> class="beau-logo" data-logo="<?php echo esc_attr($this->config['avatar'])?>" <?php } else { ?> class="beau-logo no-avatar" <?php } ?>>
                <span class="beau-version"><?php esc_attr_e( 'Version', 'beauadmin' ); ?> <?php echo esc_attr( $this->theme_version ); ?></span></div>
        ...
        public function plugin_link( $item ) {
            ...
            if ( ! isset( $installed_plugins[ $item['file_path'] ] ) ) {
                ...
                if ( ( 'LayerSlider' == $item['slug'] || 'revslider' == $item['slug'] ) && ! beauadmin()->registration->is_registered() ) {
                    $disable_class = ' disabled beauadmin-no-token';
                }
                $actions = array(
