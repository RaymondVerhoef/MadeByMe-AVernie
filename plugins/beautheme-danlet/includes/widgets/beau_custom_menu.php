...
*
*/
class danlet_custom_menu_widget extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct( 'danlet_custom_menu_widget', esc_html__(' Beau Custom Menu','citysoul'), $widget_ops );
	...
	public function widget( $args, $instance ) {
		...
		$nav_menu_args = array(
			...
			'menu'        => $nav_menu,
			'container'		=>	'',
			'menu_class'	=>	'acd_footer_list_cat',
		);
...
?><div class="acd_footer_content<?php echo esc_attr($class);?>">
	<h3 class="acd_footer_title"><?php echo $title;?></h3>
...
add_action( 'widgets_init', 'danlet_reg_custom_menu_widget' );
function danlet_reg_custom_menu_widget() {
    register_widget('danlet_custom_menu_widget');
}
